...
depth_raw = depth_raw + (np.max(depth_raw) - depth_raw) / 2 # Convert to meters
...
# ---------------------------------------------------------------------
# 5. TRANSFER COLORS TO MESH VERTICES
# ---------------------------------------------------------------------
...
# ---------------------------------------------------------------------
output_path = 'output_poisson_colored.ply'
